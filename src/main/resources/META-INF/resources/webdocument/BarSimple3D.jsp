<%-- 
    Document   : BarSimple3D
    Created on : Apr 6, 2020, 9:16:37 AM
    Author     : davidmp
--%>
              ...
              <div class="card">
                <div class="card-header">
                  <ul class="nav nav-tabs card-header-tabs" id="bologna-list" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link active" href="#description" role="tab" aria-controls="description" aria-selected="true">BarSimp3D Chart</a>
                    </li>
                    <li class="nav-item">
...
<!--                  <h4 class="card-title">Bologna</h4>
                  <h6 class="card-subtitle mb-2">Emilia-Romagna Region, Italy</h6>-->
                   ...
                   <div class="tab-content mt-3">
                    ...
                    <button type="button" class="btn btn-secondary btn-lg btn-block">BarSimp3D Chart elements or attributes</button>
...
&lt;body&gt;
&lt;% /*Here Java code*/ %&gt;
&lt;echar3D:echartBar3DSimple dataValues="&lt;%=dataValues%&gt;" idCharts="main" width="800px" height="500px" z3DMinMax="&lt;%=z3DMinMax%&gt;" /&gt;
&lt;/body&gt;
&lt;/html&gt;
        </code></pre>
        </div>                        
                    ...
                    <div class="tab-pane" id="result" role="tabpanel" aria-labelledby="deals-tab">
                      <h5 class="card-title">Result BarSimp3D Chart</h5>
                      <img src="<%=request.getContextPath()%>/webdocument/barsimple3d.png" class="card-img" alt="Bar Chart">
                    </div>
                  </div>
                </div>
              </div>
