 ...
 * @author davidmp
 */
public class Bar3DStackTagTest  extends TestCase {
    ...
    protected static final Logger logger = Logger.getLogger(Bar3DStackTagTest.class.getName());
    Bar3DStackTag instance;    
    public Bar3DStackTagTest() {
         instance = new Bar3DStackTag(pageContext);
    }
